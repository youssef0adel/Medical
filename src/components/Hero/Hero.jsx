        ...
        <div className="carousel-inner position-relative">
          <div className="carousel-item " data-bs-interval="9000">
            ...
            <div className="p-3  d-flex align-items-center h-100">
                <div className="hero-caption w-50">
                    <h5 className="text-main"> WE ARE MEDICAL</h5>
                    <h1 className=" fw-bold text-black">Miracles Made Daily</h1>
                    <p className="text-secondary lh-lg">Serving all people through exemplary health care, education, <br />research and community outreach.</p>
                </div>
          ...
          <div className="carousel-item active" data-bs-interval="9000">
            ...
            <div className="container d-flex justify-content-center align-items-center h-100">
                <div className="hero-caption text-center d-flex flex-column justify-content-center align-items-center">
                    <div className="bg-white text-main p-3 w-50 rounded-3 mb-3"><h5 className=""> WE ARE MEDICAL</h5></div>
                    
                    <div className="hero-card p-4 rounded-3 bg-main text-white"><h1 className="fs-7 fw-bold">Make a difference in the lives of others</h1></div>
                </div>
